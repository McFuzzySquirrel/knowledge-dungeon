...
Load this file when: the source document is a Product Vision (`docs/product-vision.md`) with feature documents in `docs/features/`, and no `.md` files exist in `.opencode/agents/` beyond forge templates.
