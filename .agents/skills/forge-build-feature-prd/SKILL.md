...
| Signal | Mode |
|---|---|
| `docs/product-vision.md` exists, no agent files in `.opencode/agents/` | Greenfield |
| `.opencode/agents/` contains agent files (beyond forge templates) | Post-project |
...
2. Review existing agent files in `.opencode/agents/` (agent files) - domains, responsibilities, collaboration patterns.
